...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/readlif-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13971&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/readlif-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `readlif` can be installed with:

```
conda install readlif
```

It is possible to list all of the versions of `readlif` available on your platform with:
